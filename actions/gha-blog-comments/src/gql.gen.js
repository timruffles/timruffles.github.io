...
exports.FetchIssuesDocument = graphql_tag_1.default `
    query fetchIssues($name: String!, $owner: String!, $issueLabel: [String!]) {
  repository(owner: $owner, name: $name) {
    issues(labels: $issueLabel, first: 100) {
      edges {
        node {
          id
          number
...
const FetchIssuesDocumentString = graphql_1.print(exports.FetchIssuesDocument);
function getSdk(client, withWrapper = defaultWrapper) {
    return {
        fetchIssues(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.rawRequest(FetchIssuesDocumentString, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'fetchIssues', 'query');
        }
    };
}
